...
- Write one goal for each requirement issue. If you expect more than 12 implementation issues, split the requirement. The Planner stops and proposes a split when a requirement is larger.
- Write undecided things under "Open questions". The Planner stops and asks when a question changes the plan.
...
## Out of scope
<!-- Things that the Planner must not include. -->
